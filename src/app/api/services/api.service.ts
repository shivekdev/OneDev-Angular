...
export class ApiService extends BaseService {
  ...
  /**
   * Path part for operation postsPut
   */
  static readonly PostsPutPath = '/posts';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `postsPut()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  postsPut$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.PostsPutPath, 'put');
    if (params) {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `postsPut$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  postsPut(params: {
    ...
    return this.postsPut$Response(params).pipe(
